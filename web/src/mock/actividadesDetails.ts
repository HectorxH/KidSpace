...
const portadaAct2Global: string = require('../assets/diagramas_global.png');
const portadaAct2Cuento2 : string = require('../assets/diagramas_cuento_creativo.png');
const portadaAct2Cuento1 : string = require('../assets/diagramas_cuento_intro.png');
const portadaAct2Desafio2 : string = require('../assets/diagramas_desafio_creativo.png');
const portadaAct2Desafio1 : string = require('../assets/diagramas_desafio_intro.png');
