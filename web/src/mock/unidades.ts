const unidad1Img : string = require('../assets/unidad1.jpg');
const unidad2Img : string = require('../assets/unidad2.jpg');
const unidad3Img : string = require('../assets/unidad3.jpg');
