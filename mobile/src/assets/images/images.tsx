...
const images: {
  ...
  items: {
    ...
    tecnologicas_9: require('./extras/tecnologicas/9.png'),
    tecnologicas_10: require('./extras/tecnologicas/10.png'),
    tecnologicas_11: require('./extras/tecnologicas/11.png'),
    tecnologicas_12: require('./extras/tecnologicas/12.png'),
    tecnologicas_13: require('./extras/tecnologicas/13.png'),
    tecnologicas_14: require('./extras/tecnologicas/14.png'),
    tecnologicas_15: require('./extras/tecnologicas/15.png'),
    tecnologicas_16: require('./extras/tecnologicas/16.png'),
    tecnologicas_17: require('./extras/tecnologicas/17.png'),
    camara1: require('./extras/tecnologicas/cam1.png'),
    camara2: require('./extras/tecnologicas/cam2.png'),
    camara3: require('./extras/tecnologicas/cam3.png'),
    camara4: require('./extras/tecnologicas/cam4.png'),
    phone1: require('./extras/tecnologicas/phone1.png'),
    phone2: require('./extras/tecnologicas/phone2.png'),
    phone3: require('./extras/tecnologicas/phone3.png'),
    phone4: require('./extras/tecnologicas/phone4.png'),
    phone5: require('./extras/tecnologicas/phone5.png'),
    plancha1: require('./extras/tecnologicas/plancha1.png'),
    plancha2: require('./extras/tecnologicas/plancha2.png'),
  ...
  trackingTargets: {
    ...
    camaraMomento: require('./trackingTargets/camaraMomento.png'),
    cucharaComer: require('./trackingTargets/cucharaComer.png'),
