import {actividadNombre} from '../../../types/navigation';
...
const portadaAct4Desafio1: string = require('../assets/solucionesTecno_desafio_intro.png');
...
const portadaAct5Desafio1: string = require('../assets/reciclaje_desafio_intro.png');
...
export default [
  {
    ...
    nombreActividad: 'diagramas' as actividadNombre,
    descripcion:
    ...
    cuento1:
      'En este cuento, los y las estudiantes conocerán a Diego, un florista, que trabaja diseñando y vendiendo arreglos florales. Se dará un contexto en el cual Diego debe crear un gráfico de barras, y para que este le sirva en su trabajo.',
    desafio1:
      'En este desafío, los y las estudiantes podrán interactuar con un gráfico de barras que representa las ventas de dos tipos de flores, en un entorno de realidad aumentada. Usando el menú, se podrá acceder a las preguntas asociadas al gráfico, que buscan revisar el entendimiento de cada alumno y alumna sobre cómo leer un gráfico, y cómo sacar conclusiones estadísticas de este.',
    cuento2:
      'En este cuento corto, los y las estudiantes continuarán contextualizando el uso de los gráficos y tablas. Para esto, se realizará un relato sobre el trabajo que Diego tuvo que realizar para su análisis de ventas, centrándose en el uso de hojas de cálculo. En cada paso, el o la estudiante tendrá que responder una pregunta, ayudando o dando consejos a Diego, para avanzar la historia. Se busca revisar el entendimiento básico sobre el software, tipos de datos y uso de porcentajes.',
    desafio2:
      'En este desafío, los y las estudiantes tendrán la oportunidad de ayudar a Diego en la bodega de su tienda, trabajando con las cajas de flores. Una vez analizada la cantidad de cajas de cada tipo de flor, los y las estudiantes podrán acceder a una hoja de cálculo para rellenar los valores encontrados, además de calcular los porcentajes de cada tipo de flor en la bodega. Finalmente, en base a la información ingresada, se podrá visualizar dos tipos de gráficos - un gráfico de barra y un gráfico circular.',
  ...
  },
  {
    ...
    nombreActividad: 'materiales' as actividadNombre,
    descripcion:
  ...
  },
  {
    ...
    nombreActividad: 'diseños' as actividadNombre,
    descripcion:
    ...
    cuento1:
      'En este cuento, los y las estudiantes conocerán a Luca, un diseñador de productos. En el cuento se revisarán los conceptos claves sobre los colores y la psicología de emociones, como también se hablará sobre las distintas texturas que puede tener un objeto.',
    desafio1:
      'En este desafío, los y las estudiantes podrán interactuar con 5 distintos objetos en el entorno de la realidad aumentada. El desafío consiste en aplicar y desarrollar las capacidades de análisis basado en la observación de un objeto. Usando el menú, se podrá acceder a las preguntas asociadas a los objetos vistos, que buscan revisar el entendimiento de cada alumno y alumna sobre los conceptos de texturas y colores.',
    cuento2:
    ...
    desafio2:
      'En este desafío, los y las estudiantes tendrán la oportunidad de ayudar a Luca en su trabajo, que consiste en analizar y mejorar los diseños de productos. Una vez que cada alumno y alumna observe los objetos en el entorno de realidad virtual, podrán responder las preguntas asociados a estos usando el cuaderno de observaciones de Luca. Cuando se respondan correctamente las preguntas, el cuaderno de Luca mostrará una entrada con diseño original mejorado, explicando los errores de este. Se busca reforzar los conceptos, vistos en los cuEn el quiz final los estudiantes podrán responder las preguntas asociadas a la materia de la actividad. Las respuestas serán utilizadas para proporcionar una evaluación de entendimiento para el o la docente.',
    quiz: 'En el quiz final los estudiantes podrán responder las preguntas asociadas a la materia de la actividad. Las respuestas serán utilizadas para proporcionar una evaluación de entendimiento para el o la docente.',
  ...
  },
  {
    ...
    nombreActividad: 'tecnologicas' as actividadNombre,
    descripcion:
    ...
    cuento1:
      'En este cuento, los y las estudiantes conocerán a Alec, que trabaja en el diseño industrial. En este cuento se revisarán los conceptos base sobre el análisis estructural de objetos tecnológicos, con una mirada hacia el análisis de sus partes para entender el total.',
    desafio1:
      'En este desafío, los y las estudiantes podrán aplicar lo aprendido para analizar y observar tres objetos tecnológicos. Durante la actividad, cada estudiante podrá armar y desarmar diversos objetos, para analizarlos tanto en su totalidad, como también por parte. Todo esto con el fin de comprender cómo las componentes se relacionan para dar una respuesta frente a alguna problemática específica.',
    cuento2:
      'En este cuento, los y las estudiantes  continuarán adentrándose en el mundo de los objetos tecnológicos. Durante este cuento, se desarrollará la idea sobre evolución tecnológica que sufrió todo objeto tecnológico para resolver distintos problemas de la humanidad.',
    desafio2:
    ...
    quiz: 'En el quiz final los estudiantes podrán responder las preguntas asociadas a la materia de la actividad. Las respuestas serán utilizadas para proporcionar una evaluación de entendimiento para el o la docente.',
    img1: portadaAct4Cuento1,
    img2: portadaAct4Desafio1,
    img3: portadaAct4Cuento2,
    img4: portadaAct4Desafio2,
    img5: quiz,
  ...
  },
  {
    ...
    nombreActividad: 'reciclajes' as actividadNombre,
    descripcion:
      'En esta actividad vas a conocer a José, que se dedica a la ingeniería ambiental. Junto con José, aprenderás sobre el concepto de degradación de desechos, como también de la importancia del reciclaje. Además, aprenderás sobre los puntos limpios y cómo se reciclan los desechos en Chile.',
    portada: portadaAct5Global,
    cuento1:
      'En este cuento, los y las estudiantes conocerán a José, un ingeniero ambiental. En este cuento se revisarán los conceptos relacionados con los tipos de desechos - orgánicos e inorgánicos, como también el efecto de la naturaleza de los desechos sobre el tiempo de su degradación.',
    desafio1:
      'En este desafío, los y las estudiantes podrán colocar distintos portales, que los llevarán a las distintas comunas de Santiago. Estos portales son interactivos y se puede tanto entrar, como salir de estos. Al entrar en un portal, cada estudiante se encontrará en una vista 360 de una la comuna específica. En este desafío se espera desarrollar las capacidades de observación de alumnos y alumnas, aplicando los conceptos vistos en el cuento anterior.',
    cuento2:
      'En este cuento, los y las estudiantes  continuarán adentrándose en el mundo del reciclaje. En este cuento, se hablará sobre el reciclaje en Chile, y, más específicamente, sobre los distintos tipos de desechos y su relación con los colores de basureros de los puntos limpios.',
    desafio2:
      'En este desafío, los y las estudiantes tendrán la oportunidad de jugar con objetos físicos para avanzar dentro de la aplicación. El profesor o la profesora debe entregar tarjetas físicas impresas, y los y las estudiantes tendrán la misión de escanear la tarjeta de con basurero de color indicado por la aplicación. En caso de que se haga escaneo de una tarjeta correcta, cada estudiante podrá ver los ejemplos de desechos, que se deben colocar en el basurero específico, en el entorno de la realidad aumentada.',
    quiz: 'En el quiz final los estudiantes podrán responder las preguntas asociadas a la materia de la actividad. Las respuestas serán utilizadas para proporcionar una evaluación de entendimiento para el o la docente.',
    img1: portadaAct5Cuento1,
    img2: portadaAct5Desafio1,
    img3: portadaAct5Cuento2,
    img4: portadaAct5Desafio2,
    img5: quiz,
  ...
  },
  {
    ...
    nactividad: '5',
    titulo: 'Actividad: Reciclaje',
    nombreActividad: 'reciclajesOriginal' as actividadNombre,
    descripcion:
      'En esta actividad vas a conocer a José, que se dedica a la ingeniería ambiental. Junto con José, aprenderás sobre el concepto de degradación de desechos, como también de la importancia del reciclaje. Además, aprenderás sobre los puntos limpios y cómo se reciclan los desechos en Chile.',
    portada: portadaAct5Global,
    cuento1:
